...
public class SublimeOptions implements Parcelable {
    ...
    public int getmDisplayOptions() {
        return mDisplayOptions;
    }

    public void setmDisplayOptions(int mDisplayOptions) {
        this.mDisplayOptions = mDisplayOptions;
    }

    public static int getActivateDatePicker() {
        return ACTIVATE_DATE_PICKER;
    }

    public static int getActivateTimePicker() {
        return ACTIVATE_TIME_PICKER;
    }

    public static int getActivateRecurrencePicker() {
        return ACTIVATE_RECURRENCE_PICKER;
    }
    ...
    public int getmStartDayOfMonth() {
        return mStartDayOfMonth;
    }

    public void setmStartDayOfMonth(int mStartDayOfMonth) {
        this.mStartDayOfMonth = mStartDayOfMonth;
    }
    ...
    public int getmEndDayOfMonth() {
        return mEndDayOfMonth;
    }

    public void setmEndDayOfMonth(int mEndDayOfMonth) {
        this.mEndDayOfMonth = mEndDayOfMonth;
    }
    ...
    public long getmMinDate() {
        return mMinDate;
    }

    public void setmMinDate(long mMinDate) {
        this.mMinDate = mMinDate;
    }

    public long getmMaxDate() {
        return mMaxDate;
    }

    public void setmMaxDate(long mMaxDate) {
        this.mMaxDate = mMaxDate;
    }

    public boolean ismAnimateLayoutChanges() {
        return mAnimateLayoutChanges;
    }

    public void setmAnimateLayoutChanges(boolean mAnimateLayoutChanges) {
        this.mAnimateLayoutChanges = mAnimateLayoutChanges;
    }

    public boolean ismIs24HourView() {
        return mIs24HourView;
    }

    public void setmIs24HourView(boolean mIs24HourView) {
        this.mIs24HourView = mIs24HourView;
    }

    public SublimeRecurrencePicker.RecurrenceOption getmRecurrenceOption() {
        return mRecurrenceOption;
    }

    public void setmRecurrenceOption(SublimeRecurrencePicker.RecurrenceOption mRecurrenceOption) {
        this.mRecurrenceOption = mRecurrenceOption;
    }
    ...
    public boolean ismCanPickDateRange() {
        return mCanPickDateRange;
    }

    public void setmCanPickDateRange(boolean mCanPickDateRange) {
        this.mCanPickDateRange = mCanPickDateRange;
    }

    public Picker getmPickerToShow() {
        return mPickerToShow;
    }

    public void setmPickerToShow(Picker mPickerToShow) {
        this.mPickerToShow = mPickerToShow;
    }

    public static Creator<SublimeOptions> getCREATOR() {
        return CREATOR;
    }
}
