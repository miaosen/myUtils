...
public class SublimeDatePicker extends FrameLayout {
    ...
    public static int getUNINITIALIZED() {
        return UNINITIALIZED;
    }

    public static int getViewMonthDay() {
        return VIEW_MONTH_DAY;
    }

    public static int getViewYear() {
        return VIEW_YEAR;
    }

    public static int getRangeActivatedNone() {
        return RANGE_ACTIVATED_NONE;
    }

    public static int getRangeActivatedStart() {
        return RANGE_ACTIVATED_START;
    }

    public static int getRangeActivatedEnd() {
        return RANGE_ACTIVATED_END;
    }
    ...
    public SimpleDateFormat getmYearFormat() {
        return mYearFormat;
    }

    public void setmYearFormat(SimpleDateFormat mYearFormat) {
        this.mYearFormat = mYearFormat;
    }

    public SimpleDateFormat getmMonthDayFormat() {
        return mMonthDayFormat;
    }

    public void setmMonthDayFormat(SimpleDateFormat mMonthDayFormat) {
        this.mMonthDayFormat = mMonthDayFormat;
    }
    ...
    public LinearLayout getLlHeaderDateSingleCont() {
        return llHeaderDateSingleCont;
    }

    public void setLlHeaderDateSingleCont(LinearLayout llHeaderDateSingleCont) {
        this.llHeaderDateSingleCont = llHeaderDateSingleCont;
    }

    public TextView getmHeaderYear() {
        return mHeaderYear;
    }

    public void setmHeaderYear(TextView mHeaderYear) {
        this.mHeaderYear = mHeaderYear;
    }

    public TextView getmHeaderMonthDay() {
        return mHeaderMonthDay;
    }

    public void setmHeaderMonthDay(TextView mHeaderMonthDay) {
        this.mHeaderMonthDay = mHeaderMonthDay;
    }

    public LinearLayout getLlHeaderDateRangeCont() {
        return llHeaderDateRangeCont;
    }

    public void setLlHeaderDateRangeCont(LinearLayout llHeaderDateRangeCont) {
        this.llHeaderDateRangeCont = llHeaderDateRangeCont;
    }

    public TextView getTvHeaderDateStart() {
        return tvHeaderDateStart;
    }

    public void setTvHeaderDateStart(TextView tvHeaderDateStart) {
        this.tvHeaderDateStart = tvHeaderDateStart;
    }

    public TextView getTvHeaderDateEnd() {
        return tvHeaderDateEnd;
    }

    public void setTvHeaderDateEnd(TextView tvHeaderDateEnd) {
        this.tvHeaderDateEnd = tvHeaderDateEnd;
    }

    public ImageView getIvHeaderDateReset() {
        return ivHeaderDateReset;
    }

    public void setIvHeaderDateReset(ImageView ivHeaderDateReset) {
        this.ivHeaderDateReset = ivHeaderDateReset;
    }
    ...
    public void setmAnimator(ViewAnimator mAnimator) {
        this.mAnimator = mAnimator;
    }

    public DayPickerView getmDayPickerView() {
        return mDayPickerView;
    }

    public void setmDayPickerView(DayPickerView mDayPickerView) {
        this.mDayPickerView = mDayPickerView;
    }

    public YearPickerView getmYearPickerView() {
        return mYearPickerView;
    }

    public void setmYearPickerView(YearPickerView mYearPickerView) {
        this.mYearPickerView = mYearPickerView;
    }
    ...
    public OnDateChangedListener getmDateChangedListener() {
        return mDateChangedListener;
    }

    public void setmDateChangedListener(OnDateChangedListener mDateChangedListener) {
    ...
    public SelectedDate getmCurrentDate() {
        return mCurrentDate;
    }

    public void setmCurrentDate(SelectedDate mCurrentDate) {
        this.mCurrentDate = mCurrentDate;
    }

    public Calendar getmTempDate() {
        return mTempDate;
    }

    public void setmTempDate(Calendar mTempDate) {
    ...
    public void setmMinDate(Calendar mMinDate) {
    ...
    public void setmMaxDate(Calendar mMaxDate) {
    ...
    public void setmCurrentLocale(Locale mCurrentLocale) {
        this.mCurrentLocale = mCurrentLocale;
    }

    public DatePickerValidationCallback getmValidationCallback() {
        return mValidationCallback;
    }

    public void setmValidationCallback(DatePickerValidationCallback mValidationCallback) {
        this.mValidationCallback = mValidationCallback;
    }

    public int getmCurrentlyActivatedRangeItem() {
        return mCurrentlyActivatedRangeItem;
    }

    public void setmCurrentlyActivatedRangeItem(int mCurrentlyActivatedRangeItem) {
        this.mCurrentlyActivatedRangeItem = mCurrentlyActivatedRangeItem;
    }

    public boolean ismIsInLandscapeMode() {
        return mIsInLandscapeMode;
    }

    public void setmIsInLandscapeMode(boolean mIsInLandscapeMode) {
        this.mIsInLandscapeMode = mIsInLandscapeMode;
    }

    public DayPickerView.ProxyDaySelectionEventListener getmProxyDaySelectionEventListener() {
        return mProxyDaySelectionEventListener;
    }

    public YearPickerView.OnYearSelectedListener getmOnYearSelectedListener() {
        return mOnYearSelectedListener;
    }

    public OnClickListener getmOnHeaderClickListener() {
