 ...
 * @author zms
 * @Date 2016-3-8
 * @Descrition 资源处理模块，通过反射获取R文件的资源文件(gen文件夹下可以看到),并静态化处理
 */
public class ResourceUnit {

	private static final String TAG = "ResourceUnit";
...
//	 * @return
//	 */
//	public static Map<Integer, String> getIdResounceMap(String resType) {
//		if(id2nameResounceMap.get(resType)!=null){
//			return id2nameResounceMap.get(resType);
//		}else{
//			Class<?> r = null;
//			try {
...
//					for (int i = 0; i < fields.length; i++) {
//						Field field =fields[i];
////						fieldMap.put(field[i].getInt(desireClass),
////								field[i].getName());
//						if (fields[i].getClass().getName().equals(
//								java.lang.Integer.class.getName())){
//							int value = field.getInt(desireClass);
//							L.i(TAG + "==packageName======classes===desireClass===11"+value);
//						}
//					}
//					id2nameResounceMap.put(resType, fieldMap);
//					return id2nameResounceMap.get(resType);
//				}
//			} catch (ClassNotFoundException e) {
//				e.printStackTrace();
