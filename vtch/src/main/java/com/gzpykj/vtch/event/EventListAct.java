 ...
 * @Descrition
 */
public class EventListAct extends BaseAct {
    ...
    public void initView(View view) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(EventListAct.this);
        //设置布局管理器
        rc_view.setLayoutManager(layoutManager);
        //设置为垂直布局，这也是默认的
        layoutManager.setOrientation(OrientationHelper.VERTICAL);
        //设置Adapter
        rcAdapter = new RcAdapterWithFooter(rows, R.layout.event_list_item) ;
        ...
        //设置分隔线
        rc_view.addItemDecoration(new GridViewLine(EventListAct.this));
